...
def page_key(page_name=DEFAULT_PAGE_NAME):
    return ndb.Key('Colorbook', page_name)


class Greeting(ndb.Model):
    author = ndb.StringProperty()
    colors = ndb.StringProperty(indexed=False)
